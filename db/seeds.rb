...
indicator2 = Indicator.create( name: 'Net income' )
indicator3 = Indicator.create( name: 'Debt' )
...
Value.create( report_id: report1.id, indicator_id: indicator1.id, value: 1000000 )
